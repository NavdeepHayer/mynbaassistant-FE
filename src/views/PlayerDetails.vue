...
export default {
  ...
  methods: {
    ...
    async fetchGameLogs() {
      try {
        const response = await axios.get(`http://192.168.50.157:8000/api/players/${this.player.id}/games`, {
          params: {
    ...
    async fetchSeasonStats() {
      try {
        const response = await axios.get(`http://192.168.50.157:8000/api/players/${this.player.id}/seasonstats`, {
          params: {
            limit: this.itemsPerPage,
    ...
    async fetchPlayoffStats() {
      try {
        const response = await axios.get(`http://192.168.50.157:8000/api/players/${this.player.id}/playoffstats`, {
          params: {
            limit: this.itemsPerPage,
